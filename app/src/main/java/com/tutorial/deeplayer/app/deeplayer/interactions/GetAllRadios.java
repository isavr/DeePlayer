 ...
 */
public class GetAllRadios extends UseCase {
    private static final String TAG = GetAllRadios.class.getSimpleName();

    @Override
    protected Observable buildUseCaseObservable() {
        return UserDataRepository_Factory.create().get().getRadiosFromNet();
    }
}
